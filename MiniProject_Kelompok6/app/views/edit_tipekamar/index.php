...
<body>
    ...
    <div class="form_cont">
        <h2 align="center">Edit Tipe Kamar</h2><br>
        <form class="form" action="<?=BASEURL?>/Tipe_Kamar/ubah" method="post">
            <label for="id_tipe">ID</label><br>
            <input type="number" name="id_tipe" value="<?= $data['tipe']['id_tipe']; ?>"><br>
            <label for="nama">Nama</label><br>
            <input type="text" class="form-control" id="nama_tipe" name="nama_tipe" autocomplete="off" value="<?= $data['tipe']['nama_tipe'];?>" required><br>
            <label for="fasilitas">Fasilitas</label><br>
            <input type="text" class="form-control" id="fasilitas" name="fasilitas" autocomplete="off" value="<?= $data['tipe']['fasilitas'];?>"><br>
